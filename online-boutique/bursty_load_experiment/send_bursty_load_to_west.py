...
def main():
    ...
    ## for experiment
    all_RPS_list = {
    "W300-E0-C0-S0": {"west":    {"checkoutcart": 300, "addtocart":300, "emptycart":300, "setcurrency":300}, \
                        "east":    {"checkoutcart": 0, "addtocart":0, "emptycart":0, "setcurrency":0}, \
                        "central": {"checkoutcart": 0, "addtocart":0, "emptycart":0, "setcurrency":0}, \
                        "south":   {"checkoutcart": 0, "addtocart":0, "emptycart":0, "setcurrency":0}}                    
    }
