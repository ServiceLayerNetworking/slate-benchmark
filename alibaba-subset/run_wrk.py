...
CLOUDLAB_CONFIG_XML="/users/gangmuk/projects/slate-benchmark/alibaba-subset/config.xml"
...
def run_wrk(copy_config, target_cluster, req_type, target_cluster_rps, wrk_log_path):
    ...
    lua_file = f"./wrk2/scripts/alibaba/{target_cluster}_{req_type}.lua"
...
def main():
    ...
    all_RPS_list = {
                    ...
                    # "light-w1500": {"west": {"light": 1500}}, \
                    # "light-w1600": {"west": {"light": 1600}}, \
                    # "light-w1700": {"west": {"light": 1700}}, \
