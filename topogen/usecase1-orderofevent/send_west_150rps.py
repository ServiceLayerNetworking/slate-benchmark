...
def main():
    ...
    all_RPS_list = [ \
                    ...
                    ## usecase1-orderofevent (globally optimize)
                    # {"west": 200, "south": 350, "central": 50, "east": 50}, \
                    {"west": 150}, \
                        # send east 150 more
                        # stop east 150
                        # ** send west 150 more
    ...
    inter_cluster_latency["node1"]["node4"] = 100 # west, south
    inter_cluster_latency["node2"]["node3"] = 100 # east, central
