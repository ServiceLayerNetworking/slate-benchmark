...
def main():
    ...
    all_RPS_list = [ \
                    ...
                    ## usecase1-whichcluster (globally optimize)
                    {"west": 500, "south": 500, "central": 100, "east": 50}, \
                    # {"west": 400, "south": 400, "central": 100, "east": 50}, \
                    {"west": 600, "south": 600, "central": 100, "east": 50}, \
                    ]
    ...
    inter_cluster_latency["node1"]["node2"] = 30 # west, east
    ...
    inter_cluster_latency["node2"]["node4"] = 30 # east, south
