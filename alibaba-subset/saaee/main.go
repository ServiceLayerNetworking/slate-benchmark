...
func POSTlight(c *gin.Context) {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://db2af0:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc660d:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc59ee:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
...
func POSTheavy(c *gin.Context) {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://db2af0:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc660d:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc59ee:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
