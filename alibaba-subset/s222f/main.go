...
func POSTlight(c *gin.Context) {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://db3dd1:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc676c:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc46a6:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc01d6:8080/light", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
...
func POSTheavy(c *gin.Context) {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://db3dd1:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc676c:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
	...
	go func() {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc46a6:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
		...
		rand.Read(data)
		client = &http.Client{}
		req, err = http.NewRequest("POST", "http://mc01d6:8080/heavy", bytes.NewBuffer(data))
		if err != nil {
			panic(err)
		}
		for _, v := range propogate {
